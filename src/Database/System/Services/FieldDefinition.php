...
/**
 * @method FieldDefinition action(string $action)               Sets the field action
 * @method FieldDefinition id(string $id)                       Sets the unique id for the field
 * @method FieldDefinition name(string $name)                   Sets the name of the field
 * @method FieldDefinition on(string $collection)               Sets the target collection name
 * @method FieldDefinition collection(string $collection)       Sets the collection of the field
 * @method FieldDefinition collection_id(string $collection_id) Sets the collection_id of the field
 * @method FieldDefinition type(string $type)                   Sets the type of the field
 * @method FieldDefinition interface(string $interface)         Sets the interface of the field
 * @method FieldDefinition options(array|string $options)       Sets the field interface options
 * @method FieldDefinition locked()                             Sets the field as locked
 * @method FieldDefinition validation(string $validation)       Sets the field validation
 * @method FieldDefinition required()                           Sets the field as required
 * @method FieldDefinition hidden_detail()                      Sets the field as hidden_detail
 * @method FieldDefinition hidden_browse()                      Sets the field as hidden_browse
 * @method FieldDefinition index(int $index)                    Sets the field sort index
 * @method FieldDefinition width(string $width)                 Sets the field width
 * @method FieldDefinition note(string $note)                   Sets the field note
 * @method FieldDefinition readonly()                           Sets the field as readonly
 */
